...
function Reclamacao() {
  ...
  const enviarReclamacao = useCallback(async (isAnonimo) => {
    ...
    try {
        ...
        formDataToSend.append('dataHora', manifestacoesService.formatarDataHora(formData.dataHora));
        ...
        const criado = await manifestacoesService.criarReclamacao(formDataToSend);
